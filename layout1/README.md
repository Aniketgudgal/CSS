...
- Homepage wide hero and feature area:
  ![Homepage wide hero](img/main-img-1.png)

- Page sections and footer snapshots:
  ![Sections and footer](img/main-img-2.png)

How to view
- Place the preview images in: layout1/img/ as:
  - img/layout1.png
  - img/screenshot-hero.png
  - img/screenshot-sections.png
- Preview this README in VS Code or on GitHub to see the embedded images.